 ...
 */
final class Version20210616104417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $password = '$2y$13$kwbVf4Z5zpEMqz.0vuUBpOHx4sYQIxiFeNpiZ2zMsYD8HfftXR7nS';

        $this->addSql("INSERT INTO admin (id, username, roles, password) VALUES (nextval('admin_id_seq'), 'admin', '[\"ROLE_ADMIN\"]', '{$password}')");
    }
